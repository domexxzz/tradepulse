/** เนื้อหาเว็บทั้งหมด (แก้ที่นี่ที่เดียว) — อิงสเปกฟีเจอร์จริงของ TradePulse ไม่มีสถิติ/รีวิวปลอม */
...
export const coreIntro =
  "TradePulse รวมเครื่องมืออ่านโครงสร้างราคา โซนสำคัญ และสัญญาณสำหรับวางแผนเทรดไว้ในอินดิเคเตอร์เดียว เพื่อช่วยให้ผู้ใช้เห็นบริบทของตลาดก่อนตัดสินใจ";
...
export const advancedIntro =
  "สำหรับผู้ที่ต้องการปรับมุมมองและวิเคราะห์กราฟได้ลึกขึ้น TradePulse มีเครื่องมือเสริมที่เปิดใช้ตามสไตล์การเทรดของแต่ละคนได้";
