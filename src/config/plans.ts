 ...
 * และได้ชุดราคานี้ต่อไป "ตราบที่ต่ออายุต่อเนื่อง" — ขาดอายุเกินช่วงผ่อนผันแล้ว
 * กลับมาสมัครใหม่จะได้ราคาปัจจุบันแทน ตรรกะอยู่ที่ isPriceLockValid() ใน lib/pricing.ts
 *
