...
/**
 * แบนเนอร์โฆษณาลอยบนหน้าแรก — เปลี่ยนรูปแบบตามที่ว่างของจอ
 *
 *   >= 1536px  แถบตั้งสองข้าง ซ้าย = โปร, ขวา = คู่มือ
 *   <  1536px  การ์ดกะทัดรัดใบเดียวมุมซ้ายล่าง รวมสองข้อความไว้ด้วยกัน
 *
 * ทำไมต้องแยกสองแบบ: คอนเทนต์กว้าง 1180px จอ 1366px จึงเหลือข้างละ 93px
 * ซึ่งไม่พอวางแถบตั้งที่อ่านรู้เรื่อง ถ้าดันใส่ไปมันจะทับเนื้อหา
 * ช่วง 768-1535px เดิมไม่เห็นอะไรเลย เพราะ MobileStickyCTA เป็น md:hidden
 * (หายตั้งแต่ 768) ส่วนแถบตั้งก็ยังไม่ถึงเกณฑ์ การ์ดใบนี้มาปิดช่องว่างตรงนั้น
 *
 ...
 *
 * z-30 อยู่ใต้ Navbar กับ ChatWidget (z-50) และเหนือ MobileStickyCTA (z-40)
 * ไม่ทับกันเพราะ ChatWidget อยู่ขวา ส่วนการ์ดนี้อยู่ซ้าย
 */
 ...
 *
 * บนมือถือต้องยกสูงพ้น MobileStickyCTA (สูง ~60px) ไม่งั้นทับกัน
 * ตั้งแต่ 768px ขึ้นไปแถบนั้นหายแล้ว จึงลงมาชิดขอบล่างได้
 */
  ...
  return (
    <aside
      ...
      className={[
        ...
        // ยกสูงพ้น MobileStickyCTA (สูง ~60px) ซึ่งมีเฉพาะจอต่ำกว่า md
        "bottom-[5.25rem] md:bottom-5",
