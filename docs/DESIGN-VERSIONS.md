...
เจ้าของโปรเจกต์เรียกเวอร์ชันด้วยชื่อสั้น (V4 / V5 / V6) เวลาสั่งงาน ไม่ได้เรียกด้วย commit hash

| ref | คืออะไร | commit |
|---|---|---|
| `v6` | **ตัวที่ deploy อยู่ตอนนี้** — หัวหน้าเว็บสองคอลัมน์ (การ์ด + บล็อกโปร) พาดหัวไทย คลิป Hero เข้มเท่าภาพนิ่ง | `138f64d` |
