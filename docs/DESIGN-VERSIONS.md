...
เจ้าของโปรเจกต์เรียกเวอร์ชันด้วยชื่อสั้น (V4 / V5 / V6 / V7) เวลาสั่งงาน ไม่ได้เรียกด้วย commit hash

| ref | คืออะไร | commit |
|---|---|---|
| `v7` | **ตัวที่ deploy อยู่ตอนนี้** — V6 + ถอดคำรับประกันคืนเงิน 7 วันออกจากทุกจุดที่โฆษณา | `f138cb5` |
